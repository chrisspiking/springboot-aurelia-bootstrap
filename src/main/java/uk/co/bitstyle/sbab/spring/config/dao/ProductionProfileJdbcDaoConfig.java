...
import uk.co.bitstyle.sbab.spring.config.dao.silliness.ProdSillyDao;
...
@Configuration
@Profile("production")
public class ProductionProfileJdbcDaoConfig extends BaseJdbcDaoConfig {
